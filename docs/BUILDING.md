...
This command creates the Docker image for Chevereto by downloading the software at `./chevereto` and then build from [Dockerfile](../Dockerfile). It will generate multiple semantic version tags `4.5.0`, `4.5` and `4`.
...
| ------- | ---------------- | ---------------------------- |
| VERSION | `VERSION=4.5`    | System version (4.x)         |
...
| ------- | --------------------- | ----------------- |
| default | chevereto:VERSION     | chevereto:4.5     |
| dev     | chevereto-dev:VERSION | chevereto-dev:4.5 |
| any     | chevereto-any:VERSION | chevereto-any:4.5 |
